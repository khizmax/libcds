...
for %%A in (x64 Win32) do (
  ...
  %MSBUILD% %vcXX%\cds.sln /t:Build /p:Configuration=%cfg% /p:Platform=%%A /fl /flp:LogFile=%vcXX%_%%A.log;Encoding=UTF-8;Verbosity=normal /v:normal /maxcpucount %3 %4 %5 %6 %7 %8 %9
)
