...
namespace {
    ...
    class IntrusiveEllenBinTree_Nogc: public cds_test::intrusive_tree_nogc
    {
    public:
        ...
        TEST_F( IntrusiveEllenBinTree_Nogc, base_cmp )
        {
            typedef ci::EllenBinTreeNogc<key_type, base_item_type,
