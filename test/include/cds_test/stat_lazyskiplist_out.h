#ifndef CDSTEST_STAT_LAZYSKIPLIST_OUT_H
#define CDSTEST_STAT_LAZYSKIPLIST_OUT_H

#include <cds/intrusive/details/lazy_skip_list_base.h>

namespace cds_test {

    static inline property_stream& operator <<( property_stream& o, cds::intrusive::lazy_skip_list::empty_stat const& /*s*/ )
    {
        return o;
    }

    static inline property_stream& operator <<( property_stream& o, cds::intrusive::lazy_skip_list::stat<> const& s )
    {
        {
...
#endif // #ifndef CDSTEST_STAT_LAZYSKIPLIST_OUT_H
